...
- **2026-08-23 完成面板不显示 + QA/数字人 Bootstrap 壳**：擦拭完成后不弹"M5 擦拭耦合剂完成"；M5 数字人/QA 由 M3DigitalHumanBootstrap 装配（Adapt 清理 M2 旧 M1 组件/节点，QAPanel 与 DigitalHumanStage 保持空壳）。详见 low-code.md 5.4。
